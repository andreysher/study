...
! $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/cannon/F95/MPI/0/long/matmul.f90 $
...
SUBROUTINE multijk( matrixC, matrixA, matrixB, mA, nA, nB )
	...
	INTEGER(kind=8), DIMENSION(:, :) :: matrixC(mA,nB), matrixA(mA,nA), matrixB(nA,nB)
