 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/BLAS1/C/0/ATLAS/saxpy/kernel_main.c $
 * For license details see COPYING in the package base directory
 *******************************************************************/
/* Kernel: Measurment of saxpy performance
 *******************************************************************/
...
#ifdef USE_MKL
  #include <mkl_cblas.h>
  #define BLASOP cblas_saxpy	/* blas operation */
#endif
#ifdef USE_ACML
  #include <acml.h>
  #define BLASOP saxpy		/* blas operation */
#endif
#ifdef USE_ATLAS
  #include <cblas.h>
  #define BLASOP cblas_saxpy	/* blas operation */
