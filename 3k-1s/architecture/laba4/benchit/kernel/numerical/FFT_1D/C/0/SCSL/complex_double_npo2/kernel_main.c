 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/FFT_1D/C/0/SCSL/complex_double_npo2/kernel_main.c $
...
void bi_getinfo(bi_info* infostruct)
{
   ...
   infostruct->kerneldescription = bi_strdup("1D Fast Fourier Transform, Non-Powers of 2, double precision, complex data, SCSL (C)");
