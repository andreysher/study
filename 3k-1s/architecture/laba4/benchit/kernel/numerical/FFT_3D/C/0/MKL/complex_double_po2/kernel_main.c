 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/FFT_3D/C/0/MKL/complex_double_po2/kernel_main.c $
...
void bi_getinfo(bi_info* infostruct)
{
   ...
   infostruct->kerneldescription = bi_strdup("3D Fast Fourier Transform, Powers of 2, double precision, complex data, MKL (C)");
