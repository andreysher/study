 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/vecadd/F77/0/0/CjxxEBjxxPAjxx/work.c $
...
void bi_getinfo(bi_info * infostruct) {
   ...
   infostruct->codesequence = bi_strdup("vecadd: c(jxx)=b(jxx)+a(jxx)");
   infostruct->kerneldescription =
      bi_strdup("Measure flop/s of vector addition: c(jxx)=b(jxx)+a(jxx)");
...
int bi_entry(void *mdpv, int iproblemSize, double *dresults) {
   ...
   flop = (double)imyproblemSize * (double)pmydata->repetitions;
