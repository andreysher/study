 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/vecadd/F77/0/0/BjxxEBjxxPAi/work.c $
...
void bi_getinfo(bi_info * infostruct) {
   ...
   infostruct->kerneldescription =
      bi_strdup("Measure flop/s of vector addition: b(jxx)=b(jxx)+a(i)");
