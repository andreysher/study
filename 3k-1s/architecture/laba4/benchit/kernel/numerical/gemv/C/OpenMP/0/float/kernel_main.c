 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/gemv/C/OpenMP/0/float/kernel_main.c $
      ...
      switch (j) {
         case 1:
            do {
               ...
               for (i = 0; i < numberOfRuns; i++) {
                  ji_(imyproblemSize, imyproblemSize, 1.1, 0.9, mdp->a, mdp->x,
                      mdp->y);
               }
               stop = bi_gettime();
         ...
         case 0:
            do {
               ...
               start = bi_gettime();
               for (i = 0; i < numberOfRuns; i++)
                  ij_(imyproblemSize, imyproblemSize, 1.1, 0.9, mdp->a, mdp->x,
                      mdp->y);
               stop = bi_gettime();
               stop = stop - start - dTimerOverhead;
               numberOfRuns = numberOfRuns * 8;
