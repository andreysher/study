 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/gemv/C/SSE2_Intrinsics/0/aligned_m128d/kernel_main.c $
...
void *bi_init(int problemSizemax) {
   ...
   mdp->x = _mm_malloc((maxsize * maxsize) * sizeof(double), 16);
   IDL(3, printf("Alloc 1 done\n"));
   mdp->y = _mm_malloc((maxsize) * sizeof(double), 16);
   IDL(3, printf("Alloc 2 done\n"));
   mdp->a = _mm_malloc((maxsize) * sizeof(double), 16);
