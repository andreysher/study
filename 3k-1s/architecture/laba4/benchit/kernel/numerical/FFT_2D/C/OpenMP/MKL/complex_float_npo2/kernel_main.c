 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/FFT_2D/C/OpenMP/MKL/complex_float_npo2/kernel_main.c $
...
void bi_getinfo(bi_info* infostruct)
{
   ...
   infostruct->kerneldescription = bi_strdup("2D Fast Fourier Transform, Non-Powers of 2, single precision, complex data, MKL (C), OpenMP version");
