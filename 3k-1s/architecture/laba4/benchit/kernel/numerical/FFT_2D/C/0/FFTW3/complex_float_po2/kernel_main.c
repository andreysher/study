 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/FFT_2D/C/0/FFTW3/complex_float_po2/kernel_main.c $
...
void bi_getinfo(bi_info* infostruct)
{
   ...
   infostruct->kerneldescription = bi_strdup("2D Fast Fourier Transform, Powers of 2, single precision, complex data, FFTW3 (C)");
