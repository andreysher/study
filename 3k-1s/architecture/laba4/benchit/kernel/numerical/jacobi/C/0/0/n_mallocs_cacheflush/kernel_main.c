 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/jacobi/C/0/0/n_mallocs_cacheflush/kernel_main.c $
...
void *bi_init(int problemSizemax) {
   ...
   /* problem specific malloc is done in bi_entry */
   pmydata->a = NULL;
   pmydata->b = NULL;
   pmydata->f = NULL;
...
int bi_entry(void *mdpv, int iproblemSize, double *dresults) {
   ...
   /* malloc matricies */
   pmydata->a = 
      (double *)malloc(pmydata->maxn * pmydata->maxn * sizeof(double));
   if (pmydata->a == NULL) {
      printf("No more core\n");
      exit(127);
   }
