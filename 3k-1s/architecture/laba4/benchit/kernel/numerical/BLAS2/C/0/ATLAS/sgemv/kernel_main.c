 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/BLAS2/C/0/ATLAS/sgemv/kernel_main.c $
 * For license details see COPYING in the package base directory
 *******************************************************************/
/* Kernel: Measurment of sgemv performance
 *******************************************************************/
...
#ifdef USE_MKL
  #include <mkl_cblas.h>
  #define BLASOP cblas_sgemv	/* blas operation */
#endif
#ifdef USE_ACML
  #include <acml.h>
  #define BLASOP sgemv		/* blas operation */
#endif
#ifdef USE_ATLAS
  #include <cblas.h>
  #define BLASOP cblas_sgemv	/* blas operation */
...
void* bi_init(int problemSizemax)
{
   ...
   * elseif you must call cblas_sgemv with "CblasRowMajor" and thru that the algo
