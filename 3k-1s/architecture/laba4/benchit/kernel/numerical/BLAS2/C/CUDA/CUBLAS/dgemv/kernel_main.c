 ...
 * $URL: svn+ssh://benchit@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/BLAS2/C/CUDA/CUBLAS/dgemv/kernel_main.c $
 * For license details see COPYING in the package base directory
 *******************************************************************/
/* Kernel: Measurement of Nvidia CUBLAS dgemv performance
 *******************************************************************/
