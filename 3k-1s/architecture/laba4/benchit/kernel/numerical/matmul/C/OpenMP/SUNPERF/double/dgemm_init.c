 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/matmul/C/OpenMP/SUNPERF/double/dgemm_init.c $
...
void bi_getinfo(bi_info* infostruct) {
  ...
  allocYAxis(infostruct);
	...
	infostruct->kerneldescription = bi_strdup("Matrix Multiply, BLAS, SUNPERF (C)");
}
