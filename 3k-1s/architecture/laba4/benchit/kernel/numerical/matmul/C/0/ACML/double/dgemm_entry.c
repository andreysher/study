 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/matmul/C/0/ACML/double/dgemm_entry.c $
...
int bi_entry(void *mcb, int problemSize,double *results){
	...
	size = (double)bi_get_list_element(problemSize);
	results[0] = size;
