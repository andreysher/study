 ...
 *
 * $Id: matmul_sub.c 12 2009-09-18 15:34:53Z domke $
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/matmul/F77/MPI/0/MPI_F77/matmul_sub.c $
...
void bi_getinfo(bi_info * infostruct)
   ...
   infostruct->num_measurements = MAXPROBLEMSIZE;
   ...
   for (ii = 0; ii < infostruct->numfunctions; ii++)
   {
      ...
      infostruct->legendtexts[ii] = bi_strdup("ikj");
   }
