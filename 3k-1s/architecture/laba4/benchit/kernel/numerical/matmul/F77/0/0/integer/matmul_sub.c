 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/matmul/F77/0/0/integer/matmul_sub.c $
...
void *bi_init(int problemSizemax)
{
  ...
  myfds->feld1 = (myinttype*) malloc(problemSizemax*problemSizemax * sizeof(myinttype));
  IDL(3, printf("Alloc 1 done\n"));
  myfds->feld2 = (myinttype*) malloc(problemSizemax*problemSizemax * sizeof(myinttype));
  IDL(3, printf("Alloc 2 done\n"));
  myfds->feld3 = (myinttype*) malloc(problemSizemax*problemSizemax * sizeof(myinttype));
