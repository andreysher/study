 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/numerical/elementary/F77/0/0/sqrt/work.h $
...
void (*mathop)(FPT *, FPT *);
extern void mathopsqrt_(FPT *arg1, FPT *arg2);
