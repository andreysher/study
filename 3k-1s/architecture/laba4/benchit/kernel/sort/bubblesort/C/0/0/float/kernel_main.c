 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/sort/bubblesort/C/0/0/float/kernel_main.c $
...
void bi_getinfo(bi_info * infostruct)
{
   ...
   infostruct->codesequence = bi_strdup("go through array and change neighbours if necessary");
   infostruct->kerneldescription = bi_strdup("Bubblesort Float");
   ...
   /* setting up y axis texts and properties */
      ...
      infostruct->legendtexts[0] = bi_strdup("float elements");
...
int bi_entry(void * mdpv, int iproblemSize, double * dresults)
{
  ...
  */
  ...
  if (!(verifyf(psortarray,imyproblemSize))) printf("Verification floatsort failed! \n");
