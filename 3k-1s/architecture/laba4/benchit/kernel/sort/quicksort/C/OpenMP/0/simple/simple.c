 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/sort/quicksort/C/OpenMP/0/simple/simple.c $
...
void quicksort_wikipedia_int_parallel(int * a, int al, int ar) {
#if (_OMPENMP >= 200805)
    #pragma omp parallel
#endif
    {
...
#endif
        quicksort_wikipedia_int (a,al,ar);
    }
...
void quicksort_wikipedia_flt_parallel(float * a, int al, int ar) {
#if (_OMPENMP >= 200805)
    #pragma omp parallel
#endif
    {
        ...
        #pragma omp single nowait
#endif
        quicksort_wikipedia_flt (a,al,ar);
    }
...
void quicksort_wikipedia_dbl_parallel(double * a, int al, int ar) {
#if (_OMPENMP >= 200805)
    #pragma omp parallel
#endif
    {
        ...
        #pragma omp single nowait
#endif
        quicksort_wikipedia_dbl (a,al,ar);
    }
