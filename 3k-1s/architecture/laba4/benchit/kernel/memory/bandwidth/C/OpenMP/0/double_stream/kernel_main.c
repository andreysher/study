 ...
 * $URL: svn+ssh://william@rupert.zih.tu-dresden.de/svn-base/benchit-root/BenchITv6/kernel/memory/bandwidth/C/OpenMP/0/double_stream/kernel_main.c $
 ...
 *
 *         This file connects the work-part (work.f) to the 
 *         interface (benchit.c) via their headers.
 *******************************************************************/
