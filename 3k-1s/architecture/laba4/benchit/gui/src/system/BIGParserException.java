/******************************************************************************
 * B e n c h I T - Performance Measurement for Scientific Applications BIGParserException.java
 * Author: SWTP Nagel 1 Last change by: $Author: rschoene $ $Revision: 1.1 $ $Date: 2005/10/20
 * 13:13:58 $
 ******************************************************************************/
package system;

/**
 * Thrown on an error of one of the two parsers. See message for more details. For Example the
 * <code>BIGDefFileParser</code>.
 * 
