 ...
 * BIGDoubleIdentifierException.java Author: SWTP Nagel 1 Last change by: $Author: rschoene $
 * $Revision: 1.1 $ $Date: 2005/10/20 13:13:58 $
 ******************************************************************************/
package system;

/**
 * Thrown when an identifer like a filename or a parametername is tried to add twicely. For Example on
 * <code>BIGInterface.AddFile()</code> or <code>BIGInterface.AddEntry()</code>.
 * 
