 ...
 * BIGAccessViolationException.java Author: SWTP Nagel 1 Last change by: $Author: rschoene $
 * $Revision: 1.1 $ $Date: 2005/10/20 13:13:58 $
 ******************************************************************************/
package system;

/**
 * Thrown on an unauthorized call of a method. For Example when an <code>BIGEntry.SetType()</code> is called twice.
 * 
