/********************************************************************
 * BenchIT - Performance Measurement for Scientific Applications Last change by: $Author: tschuet $
 * $Revision: 1.6 $ $Date: 2007/07/10 10:41:30 $
 *******************************************************************/
...
/**
 * A JFrame to make all font-settings. <br>
...
public class BIGFontDialog extends JFrame {
	...
	/**
	 * This constructor is used if you select the item "Set Plot Fonts" in the menu "Setup". All settings will be written
	 * into the BGUI.cfg-file.
	 * 
	...
	/**
	 * This constructor is used in the config-dialog of a plot. All settings will be written into newPlotable.
	 * 
	...
	private void build() {
		...
		// build new frame
		setTitle("Choose the Fonts for Axis");
		...
		final JComboBox<String> fontBoxComment = new JComboBox<String>(availableFonts);
		final JComboBox<String> fontBoxTitle = new JComboBox<String>(availableFonts);
		final JComboBox<String> fontBoxLegend = new JComboBox<String>(availableFonts);
		final JComboBox<String> fontBoxXAxis = new JComboBox<String>(availableFonts);
		final JComboBox<String> fontBoxXAxisTicks = new JComboBox<String>(availableFonts);
		final JComboBox<String> fontBoxYAxis = new JComboBox<String>(availableFonts);
		final JComboBox<String> fontBoxYAxisTicks = new JComboBox<String>(availableFonts);
		// an array to store the combo boxes
		final Vector<JComboBox<String>> fontBoxes = new Vector<JComboBox<String>>();
		fontBoxes.add(fontBoxComment);
		fontBoxes.add(fontBoxTitle);
		fontBoxes.add(fontBoxLegend);
		fontBoxes.add(fontBoxXAxis);
		fontBoxes.add(fontBoxXAxisTicks);
		fontBoxes.add(fontBoxYAxis);
		fontBoxes.add(fontBoxYAxisTicks);

		// sizes
		String[] siz = {"8", "9", "10", "12", "14", "16", "18", "20", "24", "28", "32", "40"};
		// select size in this combobox
		final JComboBox<String> sizeComment = new JComboBox<String>(siz);
		final JComboBox<String> sizeTitle = new JComboBox<String>(siz);
		final JComboBox<String> sizeLegend = new JComboBox<String>(siz);
		final JComboBox<String> sizeXAxis = new JComboBox<String>(siz);
		final JComboBox<String> sizeXAxisTicks = new JComboBox<String>(siz);
		final JComboBox<String> sizeYAxis = new JComboBox<String>(siz);
		final JComboBox<String> sizeYAxisTicks = new JComboBox<String>(siz);
		// an array to stroe the combo boxes
		final Vector<JComboBox<String>> sizeBoxes = new Vector<JComboBox<String>>();
		sizeBoxes.add(sizeComment);
		sizeBoxes.add(sizeTitle);
		sizeBoxes.add(sizeLegend);
		sizeBoxes.add(sizeXAxis);
		sizeBoxes.add(sizeXAxisTicks);
		sizeBoxes.add(sizeYAxis);
		sizeBoxes.add(sizeYAxisTicks);
		...
		for (int i = 0; i < count; i++) {
			revalidateTestfield(fontBoxes.get(i), sizeBoxes.get(i), italBoxes[i], bolBoxes[i],
					testfields[i]);
		}
		/*
		 * revalidateTestfield( fontBoxComment, sizeComment, italComment, bolComment, fieldComment ); revalidateTestfield(
		 * fontBoxTitle, sizeTitle, italTitle, bolTitle, fieldTitle ); revalidateTestfield( fontBoxLegend, sizeLegend,
		 * italLegend, bolLegend, fieldLegend ); revalidateTestfield( fontBoxXAxis, sizeXAxis, italXAxis, bolXAxis,
		 * fieldXAxis ); revalidateTestfield( fontBoxXAxisTicks, sizeXAxisTicks, italXAxisTicks, bolXAxisTicks,
		 * fieldXAxisTicks ); revalidateTestfield( fontBoxYAxis, sizeYAxis, italYAxis, bolYAxis, fieldYAxis );
		...
		fontBoxComment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeComment, italComment,
						bolComment, fieldComment);
			}
		});
		sizeComment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxComment, ((JComboBox<?>) aevt.getSource()), italComment,
						bolComment, fieldComment);
			}
		});
		italComment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxComment, sizeComment, ((JCheckBox) aevt.getSource()),
						bolComment, fieldComment);
			}
		});
		bolComment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxComment, sizeComment, italComment,
						((JCheckBox) aevt.getSource()), fieldComment);
			}
		});
		// action listener for title
		fontBoxTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeTitle, italTitle, bolTitle,
						fieldTitle);
			}
		});
		sizeTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxTitle, ((JComboBox<?>) aevt.getSource()), italTitle, bolTitle,
						fieldTitle);
			}
		});
		italTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxTitle, sizeTitle, ((JCheckBox) aevt.getSource()), bolTitle,
						fieldTitle);
			}
		});
		bolTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxTitle, sizeTitle, italTitle, ((JCheckBox) aevt.getSource()),
						fieldTitle);
			}
		});
		...
		fontBoxLegend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeLegend, italLegend, bolLegend,
						fieldLegend);
			}
		});
		sizeLegend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxLegend, ((JComboBox<?>) aevt.getSource()), italLegend,
						bolLegend, fieldLegend);
			}
		});
		italLegend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxLegend, sizeLegend, ((JCheckBox) aevt.getSource()), bolLegend,
						fieldLegend);
			}
		});
		bolLegend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxLegend, sizeLegend, italLegend, ((JCheckBox) aevt.getSource()),
						fieldLegend);
			}
		});
		...
		fontBoxXAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeXAxis, italXAxis, bolXAxis,
						fieldXAxis);
			}
		});
		sizeXAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxXAxis, ((JComboBox<?>) aevt.getSource()), italXAxis, bolXAxis,
						fieldXAxis);
			}
		});
		italXAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxXAxis, sizeXAxis, ((JCheckBox) aevt.getSource()), bolXAxis,
						fieldXAxis);
			}
		});
		bolXAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxXAxis, sizeXAxis, italXAxis, ((JCheckBox) aevt.getSource()),
						fieldXAxis);
			}
		});
		...
		fontBoxXAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeXAxisTicks, italXAxisTicks,
						bolXAxisTicks, fieldXAxisTicks);
			}
		});
		sizeXAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxXAxisTicks, ((JComboBox<?>) aevt.getSource()), italXAxisTicks,
						bolXAxisTicks, fieldXAxisTicks);
			}
		});
		italXAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxXAxisTicks, sizeXAxisTicks, ((JCheckBox) aevt.getSource()),
						bolXAxisTicks, fieldXAxisTicks);
			}
		});
		bolXAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxXAxisTicks, sizeXAxisTicks, italXAxisTicks,
						((JCheckBox) aevt.getSource()), fieldXAxisTicks);
			}
		});
		// action listener for yAxis
		fontBoxYAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeYAxis, italYAxis, bolYAxis,
						fieldYAxis);
			}
		});
		sizeYAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxYAxis, ((JComboBox<?>) aevt.getSource()), italYAxis, bolYAxis,
						fieldYAxis);
			}
		});
		italYAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxYAxis, sizeYAxis, ((JCheckBox) aevt.getSource()), bolYAxis,
						fieldYAxis);
			}
		});
		bolYAxis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxYAxis, sizeYAxis, italYAxis, ((JCheckBox) aevt.getSource()),
						fieldYAxis);
			}
		});
		...
		fontBoxYAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(((JComboBox<?>) aevt.getSource()), sizeYAxisTicks, italYAxisTicks,
						bolYAxisTicks, fieldYAxisTicks);
			}
		});
		sizeYAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxYAxisTicks, ((JComboBox<?>) aevt.getSource()), italYAxisTicks,
						bolYAxisTicks, fieldYAxisTicks);
			}
		});
		italYAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxYAxisTicks, sizeYAxisTicks, ((JCheckBox) aevt.getSource()),
						bolYAxisTicks, fieldYAxisTicks);
			}
		});
		bolYAxisTicks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent aevt) {
				revalidateTestfield(fontBoxYAxisTicks, sizeYAxisTicks, italYAxisTicks,
						((JCheckBox) aevt.getSource()), fieldYAxisTicks);
			}
		});
		...
		try {
			useStandard = BIGInterface.getInstance().getBIGConfigFileParser()
		...
		getContentPane().add(fontPane, BorderLayout.NORTH);
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				if (plotable != null) {
					...
					/*
					 * // set the font for Comment ( BIGPlotable.fontNames[ 0 ] ) plotable.setFont(BIGPlotable.fontNames[ 0 ],
					 * fieldComment.getFont() ); // set the font for Title ( BIGPlotable.fontNames[ 1 ] )
					 * plotable.setFont(BIGPlotable.fontNames[ 1 ], fieldTitle.getFont() ); // set the font for Legend (
					 * BIGPlotable.fontNames[ 2 ] ) plotable.setFont(BIGPlotable.fontNames[ 2 ], fieldLegend.getFont() ); // set
					 * the font for XAxis ( BIGPlotable.fontNames[ 3 ] ) plotable.setFont(BIGPlotable.fontNames[ 3 ],
					 * fieldXAxis.getFont() ); // set the font for XAxisTick ( BIGPlotable.fontNames[ 4 ] )
					 * plotable.setFont(BIGPlotable.fontNames[ 4 ], fieldXAxisTicks.getFont() ); // set the font for YAxis (
					 * BIGPlotable.fontNames[ 5 ] ) plotable.setFont(BIGPlotable.fontNames[ 5 ], fieldYAxis.getFont() ); // set
					 * the font for YAxisTick ( BIGPlotable.fontNames[ 6 ] ) plotable.setFont(BIGPlotable.fontNames[ 6 ],
					 * fieldYAxisTicks.getFont() );
					 */
				} else {
	 ...
	 */
	private void loadSettings(Vector<JComboBox<String>> fontBoxes,
			Vector<JComboBox<String>> sizeBoxes, JCheckBox[] italBoxes, JCheckBox[] bolBoxes) {
		for (int i = 0; i < count; i++) {
			// set the selected font family
			fontBoxes.get(i).setSelectedItem(fonts[i].getFamily()); // .getFontName() ) ;
			// get selected sizes
			for (int j = 0; j < sizeBoxes.get(i).getItemCount(); j++)
				if (("" + fonts[i].getSize()).equals(sizeBoxes.get(i).getItemAt(j))) {
					sizeBoxes.get(i).setSelectedIndex(j);
				}
	 ...
	 */
	private void revalidateTestfield(JComboBox<?> fontBox, JComboBox<?> size, JCheckBox ital,
			JCheckBox bol, JLabel field) {
		int style = 0;
		if (ital.isSelected()) {
		...
		new Font((String) fontBox.getSelectedItem(), style, Integer.parseInt((String) size
				.getSelectedItem()));
		field.setFont(new Font((String) fontBox.getSelectedItem(), style, Integer
...
/********************************************************************
 * Log-History $Log: BIGFontDialog.java,v $ Revision 1.6 2007/07/10 10:41:30 tschuet actualize the gui-icon Revision 1.5
 * 2007/07/03 11:28:26 tschuet insert a new benchit icon into the frames Revision 1.4 2007/05/08 09:39:56 tschuet
 * reorganize imports Revision 1.3 2007/02/27 12:37:50 tschuet different bugfixes (mixer, remote folder -> see meeting
 * at february, 27th) Revision 1.2 2006/12/18 08:42:36 rschoene use standard font can be set Revision 1.1 2006/12/18
 * 08:09:34 rschoene new FontDialog
 *******************************************************************/
