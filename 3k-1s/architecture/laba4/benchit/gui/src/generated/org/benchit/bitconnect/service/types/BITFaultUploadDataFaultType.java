/**
 * BITFaultUploadDataFaultType.java
 *
...
/**
 * BITFaultUploadDataFaultType bean class
 */

public class BITFaultUploadDataFaultType
		extends
			org.benchit.bitconnect.service.types.BITFaultUploadFaultType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFaultUploadDataFaultType Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFaultUploadDataFaultType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFaultUploadDataFaultType", xmlWriter);
		} else {
	...
	public static class Factory {
		 ...
		 */
		public static BITFaultUploadDataFaultType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFaultUploadDataFaultType object = new BITFaultUploadDataFaultType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFaultUploadDataFaultType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFaultUploadDataFaultType) org.benchit.bitconnect.service.types.ExtensionMapper
