/**
 * BITFaultRegisterFaultType.java
 *
...
/**
 * BITFaultRegisterFaultType bean class
 */

public abstract class BITFaultRegisterFaultType
		extends
			org.benchit.bitconnect.service.types.BITFaultType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFaultRegisterFaultType Namespace URI =
	...
	protected org.apache.axis2.databinding.types.IDRef localConflict;
	 ...
	 */
	public org.apache.axis2.databinding.types.IDRef getConflict() {
	 ...
	 * 
	 * @param param Conflict
	 */
	public void setConflict(org.apache.axis2.databinding.types.IDRef param) {

		this.localConflict = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFaultRegisterFaultType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFaultRegisterFaultType", xmlWriter);
		} else {
		...
		if (!namespace.equals("")) {
			...
			if (prefix == null) {
				...
				xmlWriter.writeStartElement(prefix, "conflict", namespace);
				xmlWriter.writeNamespace(prefix, namespace);
				xmlWriter.setPrefix(prefix, namespace);

			} else {
				xmlWriter.writeStartElement(namespace, "conflict");
			}
		...
		if (localConflict == null) {
			...
			throw new org.apache.axis2.databinding.ADBException("conflict cannot be null!!");

		} else {

			xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localConflict));
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("", "conflict"));
	...
	public static class Factory {
		 ...
		 */
		public static BITFaultRegisterFaultType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFaultRegisterFaultType object = null;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFaultRegisterFaultType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFaultRegisterFaultType) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "conflict").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setConflict(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToIDREF(content));
