...
/**
 * BITFaultLoginFaultType bean class
 */

public class BITFaultLoginFaultType extends org.benchit.bitconnect.service.types.BITFaultType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFaultLoginFaultType Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFaultLoginFaultType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFaultLoginFaultType", xmlWriter);
		} else {
	...
	public static class Factory {
		 ...
		 */
		public static BITFaultLoginFaultType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFaultLoginFaultType object = new BITFaultLoginFaultType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFaultLoginFaultType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFaultLoginFaultType) org.benchit.bitconnect.service.types.ExtensionMapper
