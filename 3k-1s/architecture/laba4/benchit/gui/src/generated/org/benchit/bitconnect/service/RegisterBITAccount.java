...
/**
 * RegisterBITAccount bean class
 */

public class RegisterBITAccount implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "registerBITAccount", "ns2");
	...
	protected org.benchit.bitconnect.service.types.BITUserType localUser;
	 ...
	 */
	public org.benchit.bitconnect.service.types.BITUserType getUser() {
		return localUser;
	}
	 ...
	 * @param param User
	 */
	public void setUser(org.benchit.bitconnect.service.types.BITUserType param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				RegisterBITAccount.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		localUser.serialize(new javax.xml.namespace.QName("", "user"), factory, xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static RegisterBITAccount parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RegisterBITAccount object = new RegisterBITAccount();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"registerBITAccount".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RegisterBITAccount) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setUser(org.benchit.bitconnect.service.types.BITUserType.Factory.parse(reader));
