...
/**
 * BITFaultUploadFaultType bean class
 */

public abstract class BITFaultUploadFaultType
		extends
			org.benchit.bitconnect.service.types.BITFaultType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFaultUploadFaultType Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFaultUploadFaultType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFaultUploadFaultType", xmlWriter);
		} else {
	...
	public static class Factory {
		 ...
		 */
		public static BITFaultUploadFaultType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFaultUploadFaultType object = null;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFaultUploadFaultType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFaultUploadFaultType) org.benchit.bitconnect.service.types.ExtensionMapper
