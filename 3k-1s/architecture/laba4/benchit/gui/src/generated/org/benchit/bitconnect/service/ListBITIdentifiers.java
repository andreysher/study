...
/**
 * ListBITIdentifiers bean class
 */

public class ListBITIdentifiers implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "listBITIdentifiers", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				ListBITIdentifiers.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 */
		public static ListBITIdentifiers parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ListBITIdentifiers object = new ListBITIdentifiers();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"listBITIdentifiers".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (ListBITIdentifiers) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object
							.setParam(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
