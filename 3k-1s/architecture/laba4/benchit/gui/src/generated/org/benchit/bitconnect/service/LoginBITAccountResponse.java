...
/**
 * LoginBITAccountResponse bean class
 */

public class LoginBITAccountResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "loginBITAccountResponse", "ns2");
	...
	protected org.benchit.bitconnect.service.types.BITUserType localResponse;

	/**
	 * Auto generated getter method
	 * 
	 * @return org.benchit.bitconnect.service.types.BITUserType
	 */
	public org.benchit.bitconnect.service.types.BITUserType getResponse() {
	 ...
	 */
	public void setResponse(org.benchit.bitconnect.service.types.BITUserType param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				LoginBITAccountResponse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":loginBITAccountResponse", xmlWriter);
			} else {
		...
		localResponse.serialize(new javax.xml.namespace.QName("", "response"), factory, xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static LoginBITAccountResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			LoginBITAccountResponse object = new LoginBITAccountResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"loginBITAccountResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (LoginBITAccountResponse) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object
							.setResponse(org.benchit.bitconnect.service.types.BITUserType.Factory.parse(reader));
