/**
 * RegisterBITAccountResponse.java
 *
...
/**
 * RegisterBITAccountResponse bean class
 */

public class RegisterBITAccountResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "registerBITAccountResponse", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				RegisterBITAccountResponse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":registerBITAccountResponse", xmlWriter);
			} else {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList
				.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localResponse));
	...
	public static class Factory {
		 ...
		 */
		public static RegisterBITAccountResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RegisterBITAccountResponse object = new RegisterBITAccountResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"registerBITAccountResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RegisterBITAccountResponse) org.benchit.bitconnect.service.types.ExtensionMapper
