/**
 * BITFileUploadStatusSuccessType.java
 *
...
/**
 * BITFileUploadStatusSuccessType bean class
 */

public class BITFileUploadStatusSuccessType
		extends
			org.benchit.bitconnect.service.types.BITFileUploadStatusType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFileUploadStatusSuccessType Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFileUploadStatusSuccessType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFileUploadStatusSuccessType", xmlWriter);
		} else {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		attribList.add(new javax.xml.namespace.QName("http://benchit.org/bitconnect/service/types/",
				"BITFileUploadStatusSuccessType"));
	...
	public static class Factory {
		 ...
		 */
		public static BITFileUploadStatusSuccessType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFileUploadStatusSuccessType object = new BITFileUploadStatusSuccessType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFileUploadStatusSuccessType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFileUploadStatusSuccessType) org.benchit.bitconnect.service.types.ExtensionMapper
