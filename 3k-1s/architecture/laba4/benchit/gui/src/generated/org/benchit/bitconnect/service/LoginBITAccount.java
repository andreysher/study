...
/**
 * LoginBITAccount bean class
 */

public class LoginBITAccount implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "loginBITAccount", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				LoginBITAccount.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 */
		public static LoginBITAccount parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			LoginBITAccount object = new LoginBITAccount();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"loginBITAccount".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (LoginBITAccount) org.benchit.bitconnect.service.types.ExtensionMapper
