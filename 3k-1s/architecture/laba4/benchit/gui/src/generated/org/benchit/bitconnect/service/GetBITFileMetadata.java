...
/**
 * GetBITFileMetadata bean class
 */

public class GetBITFileMetadata implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "getBITFileMetadata", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetBITFileMetadata.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 */
		public static GetBITFileMetadata parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetBITFileMetadata object = new GetBITFileMetadata();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"getBITFileMetadata".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetBITFileMetadata) org.benchit.bitconnect.service.types.ExtensionMapper
