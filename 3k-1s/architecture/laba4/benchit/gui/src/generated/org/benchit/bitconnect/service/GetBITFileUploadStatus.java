...
/**
 * GetBITFileUploadStatus bean class
 */

public class GetBITFileUploadStatus implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://benchit.org/bitconnect/service/", "getBITFileUploadStatus", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetBITFileUploadStatus.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":getBITFileUploadStatus", xmlWriter);
			} else {
	...
	public static class Factory {
		 ...
		 */
		public static GetBITFileUploadStatus parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetBITFileUploadStatus object = new GetBITFileUploadStatus();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"getBITFileUploadStatus".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetBITFileUploadStatus) org.benchit.bitconnect.service.types.ExtensionMapper
