/**
 * BITFileUploadStatusFailedType.java
 *
...
/**
 * BITFileUploadStatusFailedType bean class
 */

public class BITFileUploadStatusFailedType
		extends
			org.benchit.bitconnect.service.types.BITFileUploadStatusType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFileUploadStatusFailedType Namespace URI =
	...
	protected java.lang.String localFailure;
	 ...
	 * @param param Failure
	 */
	public void setFailure(java.lang.String param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFileUploadStatusFailedType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFileUploadStatusFailedType", xmlWriter);
		} else {
		...
		if (!namespace.equals("")) {
			...
			if (prefix == null) {
				...
				xmlWriter.writeStartElement(prefix, "failure", namespace);
				xmlWriter.writeNamespace(prefix, namespace);
				xmlWriter.setPrefix(prefix, namespace);

			} else {
				xmlWriter.writeStartElement(namespace, "failure");
			}
		...
		if (localFailure == null) {
			...
			xmlWriter.writeCharacters(localFailure);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		attribList.add(new javax.xml.namespace.QName("http://benchit.org/bitconnect/service/types/",
				"BITFileUploadStatusFailedType"));

		elementList.add(new javax.xml.namespace.QName("", "failure"));

		if (localFailure != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localFailure));
		} else {
			throw new org.apache.axis2.databinding.ADBException("failure cannot be null!!");
		}
	...
	public static class Factory {
		 ...
		 */
		public static BITFileUploadStatusFailedType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFileUploadStatusFailedType object = new BITFileUploadStatusFailedType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFileUploadStatusFailedType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFileUploadStatusFailedType) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "failure").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setFailure(org.apache.axis2.databinding.utils.ConverterUtil
