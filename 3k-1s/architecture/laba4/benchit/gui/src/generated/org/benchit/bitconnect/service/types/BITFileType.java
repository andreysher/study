...
/**
 * BITFileType bean class
 */

public class BITFileType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFileType Namespace URI =
	...
	/**
	 * field for Filename This was an Attribute!
	 */
	...
	/**
	 * field for Kernel This was an Attribute!
	 */

	protected java.lang.String localKernel;
	 ...
	 * @param param Kernel
	 */
	public void setKernel(java.lang.String param) {
	...
	/**
	 * field for Filehash This was an Attribute!
	 */
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFileType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":BITFileType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "BITFileType",
						xmlWriter);
			}
		...
		if (localKernel != null) {
			...
			writeAttribute("", "kernel",
					org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localKernel), xmlWriter);

		}

		if (localFilehash != null) {

			writeAttribute("", "filehash",
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		attribList.add(new javax.xml.namespace.QName("", "filename"));

		attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFilename));

		attribList.add(new javax.xml.namespace.QName("", "kernel"));

		attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localKernel));

		attribList.add(new javax.xml.namespace.QName("", "filehash"));

		attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFilehash));
	...
	public static class Factory {
		 ...
		 */
		public static BITFileType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFileType object = new BITFileType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFileType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFileType) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (tempAttribFilename != null) {
					...
					object.setFilename(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(tempAttribFilename));
				...
				// handle attribute "kernel"
				java.lang.String tempAttribKernel =

				reader.getAttributeValue(null, "kernel");

				if (tempAttribKernel != null) {
					java.lang.String content = tempAttribKernel;

					object.setKernel(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(tempAttribKernel));

				} else {

				}
				handledAttributes.add("kernel");

				// handle attribute "filehash"
				java.lang.String tempAttribFilehash =

				reader.getAttributeValue(null, "filehash");

				if (tempAttribFilehash != null) {
					java.lang.String content = tempAttribFilehash;

					object.setFilehash(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(tempAttribFilehash));

				} else {

				}
				handledAttributes.add("filehash");
				...
				if (reader.isStartElement()
					...
					if (isReaderMTOMAware(reader)
						...
						object.setData((javax.activation.DataHandler) reader
						...
						if (reader.getEventType() == javax.xml.stream.XMLStreamConstants.START_ELEMENT
							...
							java.lang.String id = org.apache.axiom.om.util.ElementHelper.getContentID(reader,
									"UTF-8");
							object
									.setData(((org.apache.axiom.soap.impl.builder.MTOMStAXSOAPModelBuilder) ((org.apache.axiom.om.impl.llom.OMStAXWrapper) reader)
