...
/**
 * BITFileUploadStatusType bean class
 */

public abstract class BITFileUploadStatusType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFileUploadStatusType Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFileUploadStatusType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":BITFileUploadStatusType", xmlWriter);
			} else {
	...
	public static class Factory {
		 ...
		 */
		public static BITFileUploadStatusType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFileUploadStatusType object = null;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFileUploadStatusType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFileUploadStatusType) org.benchit.bitconnect.service.types.ExtensionMapper
