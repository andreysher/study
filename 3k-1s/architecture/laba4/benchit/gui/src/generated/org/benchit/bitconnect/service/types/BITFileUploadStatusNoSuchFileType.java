/**
 * BITFileUploadStatusNoSuchFileType.java
 *
...
/**
 * BITFileUploadStatusNoSuchFileType bean class
 */

public class BITFileUploadStatusNoSuchFileType
		extends
			org.benchit.bitconnect.service.types.BITFileUploadStatusType
		implements
			org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = BITFileUploadStatusNoSuchFileType Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				BITFileUploadStatusNoSuchFileType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
					+ ":BITFileUploadStatusNoSuchFileType", xmlWriter);
		} else {
		...
		if (localFilehash == null) {
			...
			throw new org.apache.axis2.databinding.ADBException("filehash cannot be null!!");
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		attribList.add(new javax.xml.namespace.QName("http://benchit.org/bitconnect/service/types/",
				"BITFileUploadStatusNoSuchFileType"));
		...
		elementList.add(new javax.xml.namespace.QName("", "filehash"));

		if (localFilehash != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localFilehash));
		} else {
			throw new org.apache.axis2.databinding.ADBException("filehash cannot be null!!");
		}
	...
	public static class Factory {
		 ...
		 */
		public static BITFileUploadStatusNoSuchFileType parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BITFileUploadStatusNoSuchFileType object = new BITFileUploadStatusNoSuchFileType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"BITFileUploadStatusNoSuchFileType".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (BITFileUploadStatusNoSuchFileType) org.benchit.bitconnect.service.types.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "filehash").equals(reader.getName())) {
