...
/**
 * <p>
 * Überschrift: The EditPanelComoSelect
 * </p>
 * <p>
 * Beschreibung: The Setup-tab from the MainEditPanel
 * </p>
 * <p>
...
public class EditPanelComboSelect extends JScrollPane // implements Scrollable
{
	...
	private JRadioButton architectureRadio = new JRadioButton("Select graph by architecture");
	/** radio button for sel b kernel */
	private JRadioButton kernelRadio = new JRadioButton("Select graph by kernel", true);
	...
	public EditPanelComboSelect(MainEditPanel ed) {
		...
		architectureRadio.addActionListener(new ActionListener() {
		...
		// the same to kernel
		kernelRadio.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
	...
	/**
	 * @return 0 if free is selected 1 if kernel is selected 2 if architecture is selected
	 */
